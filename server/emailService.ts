...
export async function sendEmailWithIdeas(
  ...
  try {
    ...
    const transporter = nodemailer.createTransport({
      service: "gmail",
      auth: {
        user: "viusmedia@gmail.com", // Default sender email
      ...
      <html>
        ...
        <body>
          ...
          <div class="footer">
            ...
            <p>© ${new Date().getFullYear()} Surprise Ideas Generator. All rights reserved.</p>
          </div>
        </body>
      </html>
    `;
    ...
    // Send the email
    const mailOptions = {
      from: 'Surprise Ideas Generator <viusmedia@gmail.com>',
      to: recipientEmail,
